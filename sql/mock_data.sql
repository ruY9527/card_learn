...
-- 1. 标签表模拟数据
-- ----------------------------
INSERT INTO `biz_tag` (`tag_name`) VALUES ('时间复杂度');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('空间复杂度');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('排序算法');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('查找算法');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('树');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('图');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('PV操作');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('进程调度');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('内存管理');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('Cache');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('中断');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('DMA');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('TCP');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('UDP');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('IP协议');
INSERT INTO `biz_tag` (`tag_name`) VALUES ('HTTP');
...
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (7, 10); -- Cache-Cache
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (8, 11); -- 中断-中断
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (9, 12); -- DMA-DMA
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (12, 7); -- PV操作-PV操作
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (13, 8); -- 进程调度-进程调度
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (14, 9); -- 虚拟内存-内存管理
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (16, 13); -- TCP三次握手-TCP
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (17, 13); -- TCP四次挥手-TCP
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (18, 13); -- TCP vs UDP-TCP
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (18, 14); -- TCP vs UDP-UDP
INSERT INTO `biz_card_tag` (`card_id`, `tag_id`) VALUES (20, 16); -- HTTP状态码-HTTP
